var size = 4;
				...
				if(document.getElementById(nId).innerHTML != "") {
					...
					if(val == nVal) {
						if(excludeIds.indexOf(nId) == -1){
							...
							document.getElementById((k+1)+""+j).style.backgroundColor = "#000";
							isMoved = true;
							score += (val+nVal);
						}
						break;
				...
				if(document.getElementById(nId).innerHTML != "") {
					...
					if(val == nVal) {
						if(excludeIds.indexOf(nId) == -1){
							...
							document.getElementById(i+""+(k+1)).style.backgroundColor = "#000";
							isMoved = true;
							score += (val+nVal);
						}
						break;
	...
	function getColor(val)
	{
		var color = "#000";
		switch(val) {
			case 2:		color = "#b342f4"; break;
			case 4:		color = "#f441df"; break;
			case 8:		color = "#e80256"; break;
			case 16:	color = "#e80202"; break;
			case 32:	color = "#e87902"; break;
			case 64:	color = "#e8e002"; break;
			case 128:	color = "#97e802"; break;
			case 256:	color = "#3fe802"; break;
			case 512:	color = "#01e878"; break;
			case 1024:	color = "#01e8c9"; break;
			case 2048:	color = "#01aee8"; break;
			default:	color = "#000";
		}
		return color;
	}
